export const chibiCharacterArt = {
  male: {
    ...
    AREN: { name: '過保護なパトロン', motif: '毛布と温かい飲み物', color: '#E9A7B0' },
  ...
  female: {
    ...
    AFTN: { name: '氷の美貌', motif: 'タブレットと氷の結晶', color: '#9FCBDD' },
    AREN: { name: '過保護なママ', motif: '毛布と救急箱', color: '#E7A6A0' },
    AFEN: { name: '魔性の聖女', motif: 'ハート形の後光と小さな杖', color: '#D49AE3' },
    ARTC: { name: '肉食系ハンター', motif: '小さな弓矢と狙いを定める姿', color: '#E98572' },
    AFTC: { name: '小悪魔な発明家', motif: '角風カチューシャと電球', color: '#80C9B8' },
    AREC: { name: 'スポットライト女優', motif: 'スポットライトと羽根扇', color: '#F1BD70' },
    AFEC: { name: '無邪気なティンカーベル', motif: '小さな羽と星のステッキ', color: '#93CD86' },
