...
export const metadata = {
  title: 'プライバシーポリシー | ダイエットキャラ診断',
  description: 'ダイエットキャラ診断のプライバシーポリシーについて',
}
        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="space-y-6 text-gray-700">
            <section>
              ...
              <p className="mb-4">
                ダイエットキャラ診断（以下「本サービス」）では、ユーザーのプライバシーを尊重し、
                個人情報の保護に努めております。
              </p>
            </section>

            <section>
              <h2 className="text-xl font-bold mb-3">収集する情報</h2>
            ...
            <section>
              <h2 className="text-xl font-bold mb-3">情報の利用目的</h2>
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>サービスの提供・運営</li>
                <li>サービスの改善・開発</li>
                <li>ユーザーサポート</li>
            ...
            <section>
              <h2 className="text-xl font-bold mb-3">第三者への提供</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold mb-3">Cookie（クッキー）について</h2>
              <p>
                本サービスでは、Google Analyticsを使用してアクセス解析を行っています。
                Cookieを無効にしても本サービスをご利用いただけますが、
                一部機能が制限される場合があります。
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                <a href="/contact" className="text-blue-500 hover:underline ml-1">こちら</a>
                からお願いいたします。
              </p>
            </section>
