...
セックスは「物語」の一部。 ロマンチックなシチュエーションや、愛の言葉がないと、ただの「痛い行為」になってしまいます。 逆に、ムードさえ完璧なら、あなたは映画のヒロインのように美しく乱れます。`
                    :
                    `あなたは、理屈じゃなく、気持ちいいことだけしていたい感覚派です。 触られるとすぐに溶けてしまう感度抜群の体を持ち、あざと可愛く甘えて、相手の理性を溶かす天才。 言葉で愛を語るより、潤んだ瞳で見つめたり、擦り寄ったりするだけで全てを解決します。

面倒な駆け引きやルールは苦手。 「今、したい気分」なら、場所や状況を問わず相手を受け入れます。 その軽やかさと無防備さが、男を勘違いさせ、沼らせる原因となります。`
